...
class StdOutReporter(BaseReporter):
    ...
    def end_generation(self, config, population, species_set):
        ...
        if self.show_species_detail:
            # andrew print('Population of {0:d} members in {1:d} species:'.format(ng, ns))
            sids = list(iterkeys(species_set.species))
            sids.sort()
            # andrew print("   ID   age  size  fitness  adj fit  stag")
            # andrew print("  ====  ===  ====  =======  =======  ====")
            for sid in sids:
                ...
                # andrew print(
                # andrew     "  {: >4}  {: >3}  {: >4}  {: >7}  {: >7}  {: >4}".format(sid, a, n, f, af, st))
        # andrew else:
        # andrew    print('Population of {0:d} members in {1:d} species'.format(ng, ns))
    ...
    def found_solution(self, config, generation, best):
        ...
        # andrew    self.generation, best.size()))
